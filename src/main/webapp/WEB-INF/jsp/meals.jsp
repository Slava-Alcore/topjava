    ...
    <div class="container">
        ...
        <div class="card border-dark">
            ...
            <div class="card-footer text-right">
                <button class="btn-danger" onclick="clearFilter()"><span class="fa fa-remove"><spring:message code="common.cancel"/></span></button>
                <button class="btn-primary" onclick="updateFilteredTable()"><span class="fa fa-filter"><spring:message code="meal.filter"/></span></button>
            </div>
        </div>
